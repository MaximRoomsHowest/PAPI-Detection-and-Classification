...
def test_tracking_manifest_matches_sequence_dataset_counts():
    ...
    assert manifest_path.exists(), "run workflows/scripts/build_sequence_tracking.py"
...
def test_yolo26n_combined_split_entries_resolve_to_images_and_labels():
    ...
    assert combined.exists(), "run workflows/scripts/prepare_yolo_sequence_dataset.py"
